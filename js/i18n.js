var I18n = {
	...
	messages : {
		...
		"en" : {
			"Confirm lose data" : "You have unsaved changes that will be lost if you close the window.\nAre you sure?",
		...
		"ca" : {
			"Confirm lose data" : "Té canvis al formulari que encara no s'han salvat i si tanca la finestra es perdran.\nVol tancar-la?",
		...
		"es" : {
			"Confirm lose data" : "Tiene cambios en el formulario que no se han salvado, si cierra la ventana los perderá.\nQuiere cerrarla?",
